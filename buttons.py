...
#         # Disable controls until port is verified
#         self.data_display.setEnabled(False)
#         self.port_verified = False
#         self.current_port = ""

#     # Add this method to the DroneControlApp class
#     def init_ui(self):
...
#         # Add COM port verification section
#         port_group = QGroupBox("COM Port Setup")
#         port_layout = QFormLayout()
        
#         self.port_input = QLineEdit()
#         self.port_input.setPlaceholderText("e.g. COM3")
#         self.verify_button = QPushButton("Verify Port")
...
#         self.port_status = QLabel("Not verified")
#         self.port_status.setStyleSheet("color: #ff5555; font-weight: bold;")
        
#         port_layout.addRow("COM Port:", self.port_input)
#         port_layout.addRow(self.verify_button)
#         port_layout.addRow("Status:", self.port_status)
...
#         self.verify_button.clicked.connect(self.verify_com_port)
#     def verify_com_port(self):
#     # """Verify the COM port connection"""
#         port = self.port_input.text().strip()
#         if not port:
#             self.port_status.setText("Please enter a COM port")
#             self.port_status.setStyleSheet("color: #ff5555; font-weight: bold;")
#             return
        
#         available_ports = [p.device for p in serial.tools.list_ports.comports()]
#         if port not in available_ports:
#             self.port_status.setText("Port not found")
#             self.port_status.setStyleSheet("color: #ff5555; font-weight: bold;")
#             return
...
#                 for _ in range(3):
#                     received = ser.read(1)
#                     if received not in [b'A', b'\r', b'\n']:
#                         self.port_status.setText("Invalid data received")
#                         self.port_status.setStyleSheet("color: #ff5555; font-weight: bold;")
#                         return
                
#                 self.port_status.setText("Connected!")
#                 self.port_status.setStyleSheet("color: #55ff55; font-weight: bold;")
#                 self.port_verified = True
#                 self.current_port = port
                
#                 # Enable the rest of the application
#                 self.data_display.setEnabled(True)
#                 self.check_required_files()
#                 self.init_threads()
#                 self.connect_signals()
                
#         except serial.SerialException:
#             self.port_status.setText("Connection failed")
#             self.port_status.setStyleSheet("color: #ff5555; font-weight: bold;")
#         except Exception as e:
#             self.port_status.setText(f"Error: {str(e)}")
#             self.port_status.setStyleSheet("color: #ff5555; font-weight: bold;")
